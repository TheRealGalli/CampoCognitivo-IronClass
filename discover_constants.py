# discover_constants_puro.py

def discover_pi():
    values = []
    for n in range(1000, 2000, 10):  # range di stabilità
        pi_estimate = 0
        sign = 1
        for k in range(n):
...
def discover_e():
    e_estimate = 0
    for n in range(0, 18):  # 18 termini bastano per 5 cifre corrette
...
if __name__ == "__main__":
    ...
    # Salvataggio su disco per sistema Iron-Class
